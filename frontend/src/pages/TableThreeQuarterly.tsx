                ...
                <table className="min-w-[640px] w-full text-sm">
                    ...
                    {rows.map((r) => (
                        <tr key={r.quarter} className="border-b hover:bg-gray-50">
                            ...
                            <td className="px-3 text-center">{r.numOfTraumaComplicationCount}</td>
                    ...
                    {rows.length > 0 && (
                        ...
                        <tr className="border-t bg-gray-50 font-semibold">
                            ...
                            <td className="px-3 text-center">{totals.numOfMotorDysfunctionCount}</td>
                            <td className="px-3 text-center">{totals.numOfTraumaComplicationCount}</td>
                            <td className="px-3 text-center">
                                {totals.numOfAnkleComplicationCount}
                            </td>
                            <td className="px-3 text-center">{totals.numOfPediatricAdverseEventCount}</td>
                            <td className="px-3 text-center">{totals.numOfSpinalComplicationCount}</td>
                            <td className="px-3 text-center">{totals.numOfHandSurgeryComplicationCount}</td>
                            <td className="px-3 text-center">{totals.numOfObstetricAdverseEventCount}</td>
                            <td className="px-3 text-center">{totals.numOfGynecologicalAdverseEventCount}</td>
                            <td className="px-3 text-center">{totals.numOfSurgicalTreatmentCount}</td>
                        </tr>
                        </tfoot>
                    )}
                </table>
