                ...
                <table className="w-full text-sm">
                    ...
                    {rows.length > 0 && (
                        ...
                        <tr className="border-t bg-gray-50 font-semibold">
                            ...
                            <td className="px-3">{totals.numOfAllergicRash}</td>
                            <td className="px-3">{totals.numOfChestDiscomfort}</td>
                            <td className="px-3">
                                {totals.numOfDelirium}
                            </td>
                            <td className="px-3">{totals.numOfDizziness}</td>
                            <td className="px-3">{totals.numOfEndotrachealIntubationDiscomfort}</td>
                            <td className="px-3">{totals.numOfEpigastricPain}</td>
                            <td className="px-3">{totals.numOfItching}</td>
                            <td className="px-3">{totals.numOfNauseaAndVomiting}</td>
                            <td className="px-3">{totals.numOfNauseaAndVomitingAndDizziness}</td>
                            <td className="px-3">{totals.numOfOther}</td>
                            <td className="px-3">{totals.numOfProlongedAnestheticRecovery}</td>
                            <td className="px-3">{totals.numOfPunctureSiteAbnormality}</td>
                            <td className="px-3">{totals.numOfTourniquetReaction}</td>
                        </tr>
                        </tfoot>
                    )}
                </table>
